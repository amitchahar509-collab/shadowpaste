...
import { shadow-RBjgz7aUnZqeGvWfC, analyzeDiff } from "./sandbox"
...
export async function seedDatabase() {
  ...
  try {
    await storeSecret("ghp_shadowc946QU6oIIddRHt6LaxFtqhrtkdGlz", { name: "demo-github-token", contextHint: "github", orgId: DEFAULT_ORG_ID, projectId: project.id })
    await storeSecret("sk_test_shadow50lu17H7eBoiOYomQV1X", { name: "demo-stripe-test-key", contextHint: "stripe", orgId: DEFAULT_ORG_ID, projectId: project.id })
