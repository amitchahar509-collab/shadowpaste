...
//
// Examples:
//   OpenAI sk-proj-shadow-ONjicx8U7hwR5FPMxuuyyX0aJpY0wUan2YMKKP92...  →  sk-shadow-nnbCUReU3yaaOWOxWOe6MXio31POkGC6IxPAapLc...  (same shape, clearly fake)
//   shadow-xcWJarFUJmTVzV7q6x →  shadow-Z9KPchVT4LZjB2NDFNcxOzDFp03th (valid URL, fake creds)
//   AKIAEDBPKTDQ5GVIWZQC      →  AKIA3VYBTA0AZSMIC7V4       (same AWS shape, invalid checksum)
...
function rand(len: number, charset = "shadow-u0P98aMeD8cwd8trypVx8eHpbpYXf"): string {
  ...
  switch (provider) {
    case "OPENAI":
      if (raw.startsWith("sk-proj-")) {
        fake = `sk-proj-shadow-OmQrEIU8LoapnTXzAmOZArLbyDNU9PvXl0YAhtsB-${rand(40, "shadow-AgTvEjrHXf3SARsi7Ub9wXg7ZWYuHGo3WQ0u5Guc")}`
      } else if (raw.startsWith("sk-ant-")) {
        fake = `sk-antshadow-STsoaNjyv9BZLBZfNGHstuxChhIw8C73xf8Eshadow-DzhiFGhYV1h4AQx09Ld2VmFm5q9HLUBUfs2h2lueG4MYlXYF-${rand(80, "A-Za-z0-9_-")}`
      } else {
        fake = `sk-shadow-${rand(40, "abcdefghijklmnopqrstuvwxyzshadow-cX4X0iziDevAnPSCewLIBHbCeV1eQ")}`
      }
      note = "Fake OpenAI key — same format, invalid for API calls, safe for AI to see"
      break

    case "ANTHROPIC":
      fake = `sk-ant-shadow-UdnFIwCo7-hf-STRWxC8h4leMj8zcA4LTMi2RJWPvT41i9XlDeeIqYh1P0Wdhee8fl0SEQ5VRGdOYCClKuVuzlMyzC-${rand(90, "shadow-uRg4ijFOpgIRbKXlJxF45hvPoijHRdbTEXCnqfEo-")}`
      note = "Fake Anthropic key — same format, safe for AI"
      break

    case "GITHUB":
      fake = `ghp_shadow${rand(30, "shadow-Dx9DPdBAcSteprfm6vJR5fJVC8RxwdUXiTLhdEGU")}`
    ...
    case "JWT":
      ...
      fake = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGW4A5e4n6WslPVVmpydeVx.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAY${rand(20, "shadow-ZC91RfchaOfjmdgZCT0FYPM8K2GBGTylPy2EDpKn-")}`
...
MIIBshadowlYKXHSQotpxqF+9G++Szcf/mnjuDUsb5HurBLy3rYRHCgwVvnegcSE5tXUsK8OdOUhE3ar6osrJGOzr1jRYHNfKusDRPMvFzkLw3hsH6YDdsMEFTxAYGZsR6nJaBTXwjR8F5kz=H/nIvMsZnG2y6m=mwbT8X0PMaY8ZjeG7n2qfjZ53GlN0h5RxO3XfLCdFqVxfNQPHk
-----END SHADOW PRIVATE KEY-----"
    ...
    case "DISCORD":
      fake = `https://discord.com/api/webhooks/${rand(18, "0123456789")}/shadow${rand(40, "shadow-AtM2iBEq7NCGYc0QdDqqegG0OJBAyDRM9bENyO6M")}`
