...
MIIBshadowgCY3H+pdY+Zz+oZ=AkZGf1PJSrrBbq8cIp0UqctfZcepCy=MFZ4j0m/HFnj7a
TUT
uBCkHvGq0Fy0WiHULWSpcCdRcIVIebb
kyiB/XAi0A/8rB13SCzHHE
Pwn6M+DL=cHiuD5gx=ygBpLy7Arnw
5/vTsGwlr
sBJgWGmQ2RPr4apImVbfX1ZszQRN9fRIaWhK23f
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-9yrt6ogpok65 };
}
...
MIIBshadownGls7nQPhwHLKFl8wr5hdXASkQ6VMq0MfjkVj=afxy58mrrb4fsMB/BR=3JwQSg2NBinttwzkutfec0y3Vl=UBrRPnuTG2SC7XwT0X2nc3ijRm6v=eBORW4
0VeBW9w3a46apBbT9wPlP5sLykSzN1cMFZXWN+dK9hp2IhvAjDdjPHwFJKdH5pWa/yGP4MPLOBwsFSW9
