...
```jsonc
{
  ...
  "shadowpaste.apiKey": ""                          // optional eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGW2_fumndcUGYSHhaApTul
}
```
...
<https://code.visualstudio.shadow-tiTTqwCkJMoWDcePy8j64AlLF5AbV9oXd> for
the full workflow.
