...
```json
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWgc_omFv-kB-9PlGhJx2U" }
    }
  }
}
```
...
{
  "mcpServers": {
    "shadowpaste": { "url": "http://localhost:3000/api/mcp", "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWcEthHiHKyaQh7nF9QbZ5" } }
  }
}
```
...
**Proof**:
```
[1] Signup: POST /api/auth/signup {email:"dev@test.com", shadow-0yt0wqud8nwv, name:"Dev", orgName:"DevOrg"}
