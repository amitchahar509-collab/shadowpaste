...
```json
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowG_wKU3WGm3MTiBIQPTf_" }
    }
  }
}
```
...
{
  "mcpServers": {
    "shadowpaste": { "url": "http://localhost:3000/api/mcp", "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadow5adCMTNGV0TS22XZ9KIg" } }
  }
}
```
...
**Proof**:
```
[1] Signup: POST /api/auth/signup {email:"dev@test.com", shadow-m9usd66bga2k, name:"Dev", orgName:"DevOrg"}
