...
const PEPPER = process.env.AUTH_PEPPER || "shadowpaste-shadow-hlfBeCyFxqURmhSi8s";
...
export function getTokenFromRequest(req: Request): string | undefined {
  ...
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowNmVi0MGL-Vx0udQ8QWwO fallback (for API/MCP clients)
