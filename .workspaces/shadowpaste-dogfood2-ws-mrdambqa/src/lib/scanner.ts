...
export const DEMO_REPO_FILES: Array<{ path: string; content: string }> = [
  {
    ...
    content: `const url = "shadow-lbTj60aNpkYvZfTSNGb6dwCbpVxCXhEyDxFr4hht"
module.exports = { url }`,
  },
  {
    path: ".env",
    content: `DATABASE_URL="postgresql://localhost/dev"
STRIPE_SECRET_KEY="sk_test_shadow7D03igrTQFQopMWBImf9"
GITHUB_TOKEN="ghp_shadowxcUvBfM89o8koG1vxpRdNxCJg9LTFo"
AWS_ACCESS_KEY_ID="AKIA2TK4ZZUYGNCIJMHQ"`,
  },
  {
