...
// from /shadow-qxu8pqgboUDr8ROFtqZyTnoM99Hm7i5khbFh.ts. The two must stay in
...
MIIBshadowbjHBpcXx3LtJCTPiWDeeA0
dz0XiGQSMuIGD
VAR9xitU/BV1RLIFYDB5F7m1GXIme9xzKRZCNF09rT4Vob2bDGPd6AQ7QQYn
TV95zPUe9p6bwHBmGNwMue=X5WYgLeSSR=sG41GVbOGFpMvfuQZsaI=nps9Hh9bqbDvGGXyxWu50XCSSXs9sV5QKrh80lJLy+3nYPn
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-5077q2q3mzix };
}
...
MIIBshadowfXEaKZsnlWa7w+VVd3zos1qQynPHKcS8gpfErBZ2uTh9sgrFDrotsj/Jfwwrj9q57R1/ufmErJ7BHO8qnO25rrOxRGOGSrYIU875u7/us9hUQwcPAWBaj
N2Sr=TYS8qDAy9W4cKYR1e7KcLBRjNE
7UOO7fca24HtGyJvlf8ljDaTB7cLQSqM0CpW7YMZVdF612VXob
