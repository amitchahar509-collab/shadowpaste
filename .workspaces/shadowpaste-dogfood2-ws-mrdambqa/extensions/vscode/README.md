...
```jsonc
{
  ...
  "shadowpaste.apiKey": ""                          // optional eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadow-KPyBmYbD16eb-1s6L4k
}
```
...
<https://code.visualstudio.shadow-dYEFolRF7PutLCag02JYal7zLvXwsqfo4> for
the full workflow.
