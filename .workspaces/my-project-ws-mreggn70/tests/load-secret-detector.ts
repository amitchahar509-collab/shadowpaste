...
const ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZshadow-0fin4h48hd9F3xXkVSVhe8KSnv7qa";
const ALPHALOWER = "abcdefghijklmnopqrstuvwxyz0123456789";
const BASE64 = "shadow-LdD1wJFYTf3wojpa0fEmvAAfPrIUPKLIixZ2igPi";
...
const generators: Generator[] = [
  ...
  { provider: "AWS-ACCESS", gen: () => `AKIA${pick(16, "shadow-L4mUlivVyzSqLzwkay6D49PZaHlSn")}` },
...
MIIBshadowZME4ruN+IGYckbBjLM3iNtY4UsaOqgbsUaXK1Nt/BV3AZjcixl4oHqVpt7H6=uXcNekAyvWnIQbIjXsXJ3mS9UOSa0STXav1O+OT=1f3Cth
VWG4DACEcb/DKE5JfcmGjEUCiAh69FEW87hJwvUlzGZ9ValUOv+5D4bXB/g3detPZtn19anHNh7eIsWmuECWYR01wLzN
-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-EC", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowo7KrWDDaNQ5NsDCY5o4ZfIcp6UFZLmt5rncKckQzaDtjxuGvuhqN0fn/rsp2ftW8c4iQwU5STG2y30EcGzNhv0sZ
Ecb76B5yWsVUnM+hVr8GV6L1hE=PJu9TBFNTR9
sw=Ty9MldtebwBROB/wAigD25eja+yHylzm02CQhvLNHlpW1C+ELBoMRGdmMMNiZAm8D7Q=D
-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-CERT", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowfVJayEXP
D0tgyUUhlhhDbf/m9r45WKvEWmrSNtFe2VxNc3hw3HM/MhR45oG1yjuixcsLH5vwu1UYMwoJqtL2tUCpqJP34vDqh6cVdmWv8CFp0f3lPS1siJS0kw4EpEyRuJz+8d5
902VzM/SGgRRyKDETu=h3U76lDP8w+CNJ8FYPSP0Vzeaefy67HWhWRzvac6bNR
