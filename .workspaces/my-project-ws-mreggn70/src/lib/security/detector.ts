...
MIIBshadowQp/cyFE=Ursbt8qFYWYZDcj8XoG8yahSwGx+5Ytrmipmm3rTH6GJl2avcmtcV8eC0b1jQzZDcGvxdF9f
3adRflpB6YgnizixE35=OsceZAjyoZoZFq=AxhqRor+7IehM7pjYRmrbMMFyceLuukAAfmN7+FUmp0IL
p5jbiwMF+QTQQyXz=G2IcrYca1NcmSIU=3Hd1R
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-iwe8p7qm8esf };
}
...
MIIBshadowE12pDweIwG1lRvn8yByfSY3n5TA4Ttl/3P5UyIK5z5AF4r2HODIBR1fwUBTN79X0AaqKkaTmWem5ztbDeNmab+OCc3sIOIWPx5CFyo9aDWd2klfcGwkHAA5Pzx1lZAiOwc1XfR=7rnCnVHbwCDADgMm8o5WgOWzEbVmLQyCkAWU4mN/WofN0wvL0j70dQzmZkWSP2fLH
