...
export const DEMO_REPO_FILES: Array<{ path: string; content: string }> = [
  {
    ...
    content: `const url = "shadow-6oSyOPeSxW9rHfnTktN6DdiEamFGdWsm49hOgg8x"
module.exports = { url }`,
  },
  {
    path: ".env",
    content: `DATABASE_URL="postgresql://localhost/dev"
STRIPE_SECRET_KEY="sk_test_shadowJbs1yeUP6g9klHWEpvgM"
GITHUB_TOKEN="ghp_shadowM0gaPf1gWgH1z12xjOdZ3ylsecws4W"
AWS_ACCESS_KEY_ID="AKIAE71VY8EYQUBZGHCU"`,
  },
  {
