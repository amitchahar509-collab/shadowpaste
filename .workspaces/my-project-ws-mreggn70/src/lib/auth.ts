...
const PEPPER = process.env.AUTH_PEPPER || "shadowpaste-shadow-gvjXgGYDcC8BaXYTkJ";
...
export function getTokenFromRequest(req: Request): string | undefined {
  ...
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAYu9f8rGvZW9xfS_3yv6G6f-rwQRrKjYqVf_Eln_rU fallback (for API/MCP clients)
