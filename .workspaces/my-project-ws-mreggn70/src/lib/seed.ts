...
import { shadow-m4baB2JsOkkYGinQZ, analyzeDiff } from "./sandbox"
...
export async function seedDatabase() {
  ...
  try {
    await storeSecret("ghp_shadow3MjZqRVos2pb7qDsYtLZVmcS42of1J", { name: "demo-github-token", contextHint: "github", orgId: DEFAULT_ORG_ID, projectId: project.id })
    await storeSecret("sk_test_shadowgWJfTsuLlrIEPParmlxU", { name: "demo-stripe-test-key", contextHint: "stripe", orgId: DEFAULT_ORG_ID, projectId: project.id })
