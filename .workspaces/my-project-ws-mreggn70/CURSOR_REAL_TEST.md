...
3. **Format-compatible fakes**: Verified — AI sees `sk-proj-shadow-nXPWFG9qXB1DThLpZFf3kcvXVJ3UEOBFZLK7ASoG` instead of real `sk-proj-shadow-tsUii3vE8p73b3iBHBcuLCXMoCacXSeEjKOHGmRy`. Code runs, tests pass.
...
// cursor-mcp.json (or ~/.cursor/mcp.json)
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAYu9f8rGvZW9xfS_3yv6G6cm2UcPIYbDqLSoizYLqa" }
    }
  }
}
```
