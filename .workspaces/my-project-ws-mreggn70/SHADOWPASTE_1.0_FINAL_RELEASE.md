...
- `sk-proj-shadow-f2qXokbK1prELRP9y2MXGCzU0TxXJQ8n1JdzxQot` → `sk-proj-shadow-4MX5OwM0uL0zl3SNnsjODalzCwvEVZSfL9jAz1Mp` (same format, invalid)
- `ghp_aBcDeFg` → `ghp_shadow-xxx` (same prefix, invalid)
- `AKIAXXCQ64I6ZVI8S3EO` → `AKIABADOE1LWQUVDXBOE` (same shape, fails checksum)
