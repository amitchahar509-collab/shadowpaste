...
MIIBshadowf4SdpDFxgNesqPhEmVrHQ5XvlnawXgyqpC6K5LSfcI0uDnebwpPUV4TyW7w=4mkvO
0jZv=pT0A4iUZPXUfQy2KEhRV5rB5QBfWg9F9ek2/hTySAmNQsmPveNqq4Tx
yu+fCQkzp/a2rLNL966qP10EVpGEYTP5T
e5B2dlYJ+xadZJiTU5jd+dD0TTF2YH2+9jYRO7O
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-7iffuikwl23f };
}
