...
```jsonc
{
  ...
  "shadowpaste.apiKey": ""                          // optional eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAYu9f8rGvZW9xfS_3yv6G6XK9FmHHlQ4w5XiKOylv_
}
```
...
<https://code.visualstudio.shadow-zdWfGAVYNMMVE0U9zfLBazV3hiSdHG0A1> for
the full workflow.
