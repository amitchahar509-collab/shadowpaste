...
import { shadow-z94XdWtatE0AZ1rjO, analyzeDiff } from "./sandbox"
...
export async function seedDatabase() {
  ...
  try {
    await storeSecret("ghp_shadowdt4B4rsglnwG1xNSQ3hnDPWHWiyMU8", { name: "demo-github-token", contextHint: "github", orgId: DEFAULT_ORG_ID, projectId: project.id })
    await storeSecret("sk_test_shadowDETaaK7xh76joGIyz5S5", { name: "demo-stripe-test-key", contextHint: "stripe", orgId: DEFAULT_ORG_ID, projectId: project.id })
