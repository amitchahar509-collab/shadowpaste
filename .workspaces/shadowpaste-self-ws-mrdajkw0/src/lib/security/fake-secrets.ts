...
//
// Examples:
//   OpenAI sk-proj-shadow-qD6YhBHv5dI5LHBsHwdmmEumCUKE7FHv0BDUj9he...  →  sk-shadow-byhLqYUEZMNUXcSCjy6y6DkC7lqSH06fnYN1S0oH...  (same shape, clearly fake)
//   shadow-EEZe7cRbUHwL7zGF62 →  shadow-dP5gy5whA2ISTxspcklU568rxS8Sa (valid URL, fake creds)
//   AKIADRWB1K1KNLGH7QPX      →  AKIAX5114AWZ2ZJ6OV8W       (same AWS shape, invalid checksum)
...
function rand(len: number, charset = "shadow-0E3A3ph4p0Op7GejHTJaPkYH0J0f7"): string {
  ...
  switch (provider) {
    case "OPENAI":
      if (raw.startsWith("sk-proj-")) {
        fake = `sk-proj-shadow-7YGfkCMXHcz0fsg7xylBNR53thFTPMLz2xsN7zk9-${rand(40, "shadow-JgmyI8diTlhbdteddl878nJ10KA6R3KpG6XqD5r9")}`
      } else if (raw.startsWith("sk-ant-")) {
        fake = `sk-ant-shadow-sOPamuPVyZFFB4noQZwF4EUR0nj8fKm4h7-eNjQl6W2VXoK3xSStI5_63cD4azrxbQAUkxHFDg4Qxo3tPUa4bnjq0l-z68iMu-01RbAv_Iyjlya5-8OMQ6yKXiV-FI7Wp-5gJcaIxPkMQcm-95G0HbwfcoNlHVUDBCXcOvJFEDqLDBNqS21Lh-${rand(80, "A-Za-z0-9_-")}`
      } else {
        fake = `sk-shadow-${rand(40, "abcdefghijklmnopqrstuvwxyzshadow-3JEx5vZKyYnbPTKfNYwVfiiTcVomh")}`
      }
      note = "Fake OpenAI key — same format, invalid for API calls, safe for AI to see"
      break

    case "ANTHROPIC":
      fake = `sk-ant-shadow-${rand(90, "shadow-ng8EbXSk1nn57IS0DLpZE37IMrrgJgXgkdSZ4vig-")}`
      note = "Fake Anthropic key — same format, safe for AI"
      break

    case "GITHUB":
      fake = `ghp_shadow${rand(30, "shadow-PoJ0KbBtBf4Lg3F57reHlrVA6B7qPFmFyOfRQ2vR")}`
    ...
    case "JWT":
      ...
      fake = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowH9J-1gGkSjBrrBcy2AmR.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowGfXl3BqWtYO1qU1jI-7A${rand(20, "shadow-TI3vmhIgVmX09gVqMzo1HfEnJapHu7JgnNnGq8jR-")}`
...
MIIBshadowCthoBzHmp5sQ/GyDqa2lLZD
zJ5LTFDUxd6OeLMr7fDw4iVz6srPiHdeUx1GPVQtGhm1qMQZFxJTwq38w=AAZhajMjJ
4qhaB6DpIneSzbwAGpXE0zhjJwOdPkgGGsuko1F42HjKj
B9UsNgKwGJG1ZunuBzlrsmMPW6Rk/S4svXSy/zVMUAM0pMeNg74niJYbVM=+o8
-----END SHADOW PRIVATE KEY-----"
    ...
    case "DISCORD":
      fake = `https://discord.com/api/webhooks/${rand(18, "0123456789")}/shadow${rand(40, "shadow-fsNLBGkm9Qgg40gCjPZwXul0JI1pNmCU7uBgHN5e")}`
