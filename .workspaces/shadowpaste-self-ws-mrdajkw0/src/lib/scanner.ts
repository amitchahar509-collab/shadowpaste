...
export const DEMO_REPO_FILES: Array<{ path: string; content: string }> = [
  {
    ...
    content: `const url = "shadow-l3ta8y5BdyvxCKyFqXaT69vEGP99p3QMT2Nyg13R"
module.exports = { url }`,
  },
  {
    path: ".env",
    content: `DATABASE_URL="postgresql://localhost/dev"
STRIPE_SECRET_KEY="sk_test_shadowUkzoLaYxdAlghywHdRSR"
GITHUB_TOKEN="ghp_shadowsrpkW0AswLAN8wuEc7WVT9L18jt1ZU"
AWS_ACCESS_KEY_ID="AKIAP713YADWQFJB9GYG"`,
  },
  {
