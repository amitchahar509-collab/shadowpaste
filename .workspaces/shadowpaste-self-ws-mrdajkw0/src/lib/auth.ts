...
const PEPPER = process.env.AUTH_PEPPER || "shadowpaste-shadow-hpwxkkPxDxbqpchL2Y";
...
export function getTokenFromRequest(req: Request): string | undefined {
  ...
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowNWrEvP8_Or33QCG2znq1 fallback (for API/MCP clients)
