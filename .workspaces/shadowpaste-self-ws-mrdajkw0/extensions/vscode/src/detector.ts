...
// from /shadow-Io6SS49GWMBYQOwckpZcgxHR9pXmCDLBS9SE.ts. The two must stay in
...
MIIBshadow6PgUDsIbLxoxj34aqPAxIfszGWm+TE14WGtKwVqoz+tb
hxnH6vUmIBAe3D/x
kzu10fPjpxz5U+MJMrbmVvlsLuov0cgdtkGuiDeZQclHQhb5Jevtm3bZY
3HrvuRpA20jQeuEKkspmx1wxX0BLyFD=YMnegV02xjqoYg9xuld5E1cmM8UrhM4PpCQDJj5
uCn3M8Ny
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-p7xkler2f5ut };
}
...
MIIBshadowP3iKt1Ng
xzNh7Zqpw5ke=4eZmkxIqC63JAkE30dDuIqRBS3gRp21fwSp8OYggDyGgng8Cuv/R5yttP/I2tLmbnFLQqvhoS4+eZDERWo/OIumeZSWLx+qlal2fCK4wDAtszDOc/lAhqqbDAxr10Bvffw=oRAsOt2V7HO5SBpbdjOOxLNgsbXwo=kohLsSN4myccMt2fQ
