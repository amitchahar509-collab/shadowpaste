...
```jsonc
{
  ...
  "shadowpaste.apiKey": ""                          // optional eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadow3vQ8flo0fNCkA-o-aPVM
}
```
...
<https://code.visualstudio.shadow-7QBz0mlAuHACC5W4UYOKIy4zooFvcrGHE> for
the full workflow.
