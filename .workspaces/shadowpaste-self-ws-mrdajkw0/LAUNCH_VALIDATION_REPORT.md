...
```json
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowM38Lcd6wf9T8dY-WF3Re" }
    }
  }
}
```
...
{
  "mcpServers": {
    "shadowpaste": { "url": "http://localhost:3000/api/mcp", "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowo1ssAdPSmKeN6tbkon4t" } }
  }
}
```
...
**Proof**:
```
[1] Signup: POST /api/auth/signup {email:"dev@test.com", shadow-il6fbyoazi2z, name:"Dev", orgName:"DevOrg"}
