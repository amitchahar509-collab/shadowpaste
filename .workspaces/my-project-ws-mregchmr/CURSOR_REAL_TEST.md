...
3. **Format-compatible fakes**: Verified — AI sees `sk-proj-shadow-KEjayEygTonAnAdbUosKP5uUURsAnG6OFGzJCScJ` instead of real `sk-proj-shadow-I6BP1bXCTag8T3mE6UpYdjV1OMu5eZCot6Zo7GR2`. Code runs, tests pass.
...
// cursor-mcp.json (or ~/.cursor/mcp.json)
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAYNKMYJD9WhnROE3G7Qbim" }
    }
  }
}
```
