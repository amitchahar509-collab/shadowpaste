...
3. Claude sees format-compatible fake secrets (sk-proj-shadow-fErtj7nDNEPTkwtMOahMWbjVOMGmTEm6QU4xq0vP)
...
// mcp.json
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAY8HWyc2DZ4V_RQMqRvxpc" }
    }
  }
}
```
