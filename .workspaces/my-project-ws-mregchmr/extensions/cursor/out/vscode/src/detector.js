...
MIIBshadowJD5U5qpToSNOTv2ywz6N4fyisMw3MpZIMh5H1hQe7JpA=MFCVVzYlP+kxCdmBNqccxyL14sTzCTlKm2BPPFXh4Zo1FicegFJNFivqsiaEmN4b4oAp9yL2ucDNkex
Uz
zS0BZCRotr
cGjX5rwcYk0grBYoE+i9fhdkP
JT9NIBqr7gjcxtxYSqDcL721sYeiXj51SYF
...
function providerLabel(raw, ctx = "") {
    ...
    if (provider === "GENERIC")
        provider = "ENV_SECRET";
    return { provider, scope: cls.scope === "generic.use" ? "env.shadow-2sdl3290ogve };
}
...
MIIBshadowgUB2OpWVtdgAzXl9WEzzLxrpTOZ0sPQHjkTECsStuBzJp/TD7Dd+lsm4NWkAOWYwvEenu0RJW0HokVjplexjNWmgSa8Rxwo1d
wZDuw9a99FczIXWGNNjqqpe/y
cp9bA6ti=wUFWkA5x1Ha3aczdInuELcTMYLk+cqXnnq8+VfHb/4KyXPvRmtHpO
+q7t+koI
b2dv
