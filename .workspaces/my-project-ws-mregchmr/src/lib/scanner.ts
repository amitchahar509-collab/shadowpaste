...
export const DEMO_REPO_FILES: Array<{ path: string; content: string }> = [
  {
    ...
    content: `const url = "shadow-pbR91CzmZ6tnLYfwRCTqgMN4s3e03vSS9rsf2Tz3"
module.exports = { url }`,
  },
  {
    path: ".env",
    content: `DATABASE_URL="postgresql://localhost/dev"
STRIPE_SECRET_KEY="sk_test_shadowZyOfYFcah1ZtWv6g1Lzo"
GITHUB_TOKEN="ghp_shadowS1iDM8seQH2aWrJdqT3aAJ1DA83hW9"
AWS_ACCESS_KEY_ID="AKIAC3VDF701XWXB4Y8T"`,
  },
  {
