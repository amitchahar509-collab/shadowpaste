...
const PEPPER = process.env.AUTH_PEPPER || "shadowpaste-shadow-JUJ9GoFsS7pi4ndohQ";
...
export function getTokenFromRequest(req: Request): string | undefined {
  ...
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAY3gpVJ_mDjleupodP7vLb fallback (for API/MCP clients)
