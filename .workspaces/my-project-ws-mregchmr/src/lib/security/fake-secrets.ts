...
//
// Examples:
//   OpenAI sk-proj-shadow-QmFBNnLDOeF4sbSAC7ioSfFvAFs6QBhuSaxH5D2Z...  →  sk-shadow-Clwhh3Gfw4fFVC9Njh1xRfihwOjm6leuDE5cRiMk...  (same shape, clearly fake)
//   shadow-GK0vUljIebu3Q6omWp →  shadow-PeoliJgl9CFmtabKuI3hbt0pzylUb (valid URL, fake creds)
//   AKIAOVZRU1EF6MI1YHHC      →  AKIA23MVTDR3WPKJ93MI       (same AWS shape, invalid checksum)
...
function rand(len: number, charset = "shadow-Ngg7BodHv2d64v44MJ7nb0gpHA3Bv"): string {
  ...
  switch (provider) {
    case "OPENAI":
      if (raw.startsWith("sk-proj-")) {
        fake = `sk-proj-shadow-ZkLxbdAQIEWGMeunnTCHM6vSMf4iQeIeIKlSvLWG-${rand(40, "shadow-VVVfgQnrFXyF7BItEJVdjdDvFeIOzEaVk90kfnda")}`
      } else if (raw.startsWith("sk-ant-")) {
        fake = `sk-antshadow-gUQBdHif0HLggFbKapyPLVqHikX6vgY0XGjZshadow-2caXR7dlRhuObktpBC9wXhvSfq9HLUBUfs2h2lueG4MYlXYF-${rand(80, "A-Za-z0-9_-")}`
      } else {
        fake = `sk-shadow-${rand(40, "abcdefghijklmnopqrstuvwxyzshadow-yVIpjZLNtvuCy7cuNvSbq69mmOuyH")}`
      }
      note = "Fake OpenAI key — same format, invalid for API calls, safe for AI to see"
      break

    case "ANTHROPIC":
      fake = `sk-ant-shadow-amdM-9ry96QbZaUD3aSwjr9sExqSMyvP002QnajPTeq4sSvw8ECXhnLVgrw1RJqr4IROravSxJS34-n5hXaDPAkwsd-${rand(90, "shadow-9PA29mmdKEEo6Wiv43hu1hwgLcaax70elNi75Y3O-")}`
      note = "Fake Anthropic key — same format, safe for AI"
      break

    case "GITHUB":
      fake = `ghp_shadow${rand(30, "shadow-aVLfRQk24op0DDmFI2tyimXHS5Q3S1yDvnI0anff")}`
    ...
    case "JWT":
      ...
      fake = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAY05TkPQ6KUEosu2avouW9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGWpsm6XuQdBXLno4UVyNAYu9f8rGvZW9xfS_3yv6G6${rand(20, "shadow-hmnJNmVrdXKCcf2aV0A3CviIGhsFQlq6CD0IHB0b-")}`
...
MIIBshadowzsQuOk43CHihaRsx9ZntujUvuMm9EGFXPV85usUs59o0UT+Qd+MX3RPoZlqWZjfc2FCyJtV7hLJfSl1G7/frdoFK9RPbg=vehbEuWlMfVaCf2kMA7ervQAagx1rk4tw7qkXKQhWoGeJXw2FoEBCiaU2tRAnfPmeAc0ZtouUoL/RP59avuQDQW5kj
KquCmtV
yoo2534
-----END SHADOW PRIVATE KEY-----"
    ...
    case "DISCORD":
      fake = `https://discord.com/api/webhooks/${rand(18, "0123456789")}/shadow${rand(40, "shadow-NKALtPZy1RdovqdA6dgIIHnyUeUUG4RM7DphUK3w")}`
