...
import { shadow-y7oVNxJBMfCgN8Cax, analyzeDiff } from "./sandbox"
...
export async function seedDatabase() {
  ...
  try {
    await storeSecret("ghp_shadowgbXl2OHO0usdIMEUL4fmMZ5Ge9Kn8W", { name: "demo-github-token", contextHint: "github", orgId: DEFAULT_ORG_ID, projectId: project.id })
    await storeSecret("sk_test_shadowppeRyMUt2DBapNIJdSzM", { name: "demo-stripe-test-key", contextHint: "stripe", orgId: DEFAULT_ORG_ID, projectId: project.id })
