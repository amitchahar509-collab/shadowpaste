...
- `sk-proj-shadow-clY6cYYLHujPouEUHQfEsGVsUQYBf1BUGadZsOwV...` → `sk-proj-shadow-cQX320jPAsOZG4AkCtCnfbWn94YYwib9dDV1SjAM-shadow-gyCkvniIhPXI9rzL4rHUXZy0Ymrh6CbMi...` (same OpenAI format)
- `ghp_aBcDeFg...` → `ghp_shadow...` (same GitHub format)
- `AKIAF6BE4IOVRP2E6WAQ` → `AKIAQPPUTTRQXMKNWTTS` (same AWS format, fails checksum)
- `sk_live_51H8xK2...` → `sk_test_shadow...` (Stripe test mode, same shape)
- `shadow-RHTlRcIVsrE7pkz39uhriW → `shadow-4u0oauJ8IBbnwYV0x87DSFJUV51sj9JHjMcXInr (valid URL, fake creds)
...
- Workspace created at `.workspaces/shadow-WaHAXV8s4lvic0RlihC4NSlMw/`
...
```
OpenAI: sk-proj-shadow-hYMUTyFkpiv16LC47dXGnixIYNQcr9AZYxisC2pD... → sk-proj-shadow-agtpqKsy9FkHBIMAFSn5ierpfxAJyCWQRyOqYx4t...  ✅ same format
Stripe: sk_live_51H8xK2... → sk_test_shadow4HYS6X1wxo8ME0h95QQI...   ✅ test mode prefix
Postgres: shadow-7OySW8mV57FzgZtvi1DV8 → shadow-Xg6o59neXe7YUqxdh5w97RAfd1TXI  ✅ valid URL
```
