...
- `sk-proj-shadow-u61Sm5up3HrZIZDOmdtmLMbiFJCVtFNvEJmigfst...` → `sk-proj-shadow-eKGCfiMWKPE9JPC7HzcZKbeZDRhEuhcSEshDeFD7...` (OpenAI)
- `ghp_aBcDeFg...` → `ghp_shadow...` (GitHub)
- `AKIAD1VNOX71KZ4EH67C` → `AKIA2RSTME0B79GPGC8M` (AWS)
- `sk_live_51H8xK2...` → `sk_test_shadow...` (Stripe)
- `shadow-NaGc7r0Ccha1iluS3UzbNg → `shadow-Oxx3avgmolXJXOFqljPz1PkVq8fsQl (Postgres)
