...
const ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZshadow-5h7yIcRijgh63cEFNDOh8MuEN7117";
const ALPHALOWER = "abcdefghijklmnopqrstuvwxyz0123456789";
const BASE64 = "shadow-GSXYAaRMNIXbfwc8ra4g4imovIWihaufKXYZaWFE";
...
const generators: Generator[] = [
  ...
  { provider: "AWS-ACCESS", gen: () => `AKIA${pick(16, "shadow-Zk7xcmEM3lLIdiR8Sh6xSiWzGYo9U")}` },
...
MIIBshadowessub1PIhbDyB1Yxo5nSPm2yX8opYA1iOBkCtKWRsozplOJP9P02jRs+RC/JbRbkUwLvMM+p4nKHBHYccKXqkns7puiv7+geGc0a4TmTqVnJmxa646fPHylgOD
IGBclohNz
SRpT91utqHBFVtVvBFo9l+n92NXwesy3ojULkzWnLMqxQddzclZfH2BmzDXc1/wRq7F
-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-EC", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowFym2rnYjJgj6SC0ZoGwH3=v515T04cL6LM3EOz6mLwCDmGv0plS4=MPQP4yFEUwatwwxY+nH
CWnRdYLmyaRdgel6BcUWFpTzpjiiEp7GtROORhQfq0RHJQhHLIcx=Tvip1J8pHJXjwL=W6V6aNN/1xi3Q11hD1mS+78R/JMO
ULtvreYrOHlfn8
3LpyvTYPaBXY+eL
-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-CERT", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowBOYevYOV4IrScjUI0xLxrdhuEAtG3HNtc2WxkkO2YnsnVaMPZZ5Jnl/m=SBCwqpjR9cZ=IPqilcmtTcu+uQs3jifnegVydqQ1gyycvDdwZyptGDuNUAnWRNuS1suGcGYFcJHlRjZU3oD42mH8gn8Xzjwb58Hh8IndjjncCwzPeeMBC4it5CNDz3v4+rW932mrVW+AAHv
-----END SHADOW PRIVATE KEY-----` },
