...
export const DEMO_REPO_FILES: Array<{ path: string; content: string }> = [
  {
    ...
    content: `const url = "shadow-gOGZXSx56UikcGI31T88sUXXkcDQ9VB9BUZgsjL9"
module.exports = { url }`,
  },
  {
    path: ".env",
    content: `DATABASE_URL="postgresql://localhost/dev"
STRIPE_SECRET_KEY="sk_test_shadowgqIx1SuQYa1jvz1vh4ld"
GITHUB_TOKEN="ghp_shadow012c4Wb5t1j4g5fZNNPo1a6l8XFHCZ"
AWS_ACCESS_KEY_ID="AKIANWCUU1BRVDMJM5NR"`,
  },
  {
