...
const PEPPER = process.env.AUTH_PEPPER || "shadowpaste-shadow-Gfsl3OKgb5ux5XMTC4";
...
export function getTokenFromRequest(req: Request): string | undefined {
  ...
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowk3PZ4a7duTSO4EeSRNHW fallback (for API/MCP clients)
