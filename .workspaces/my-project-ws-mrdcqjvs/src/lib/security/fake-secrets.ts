...
//
// Examples:
//   OpenAI sk-proj-shadow-byOp4dZDC5wm1YpBSLDEtf2S3XC1yZEMUSxHAGMQ...  →  sk-shadow-PrprsdA87czhNHeIH2NGfvfXxuM1cc4iONcDRKHg...  (same shape, clearly fake)
//   shadow-USSQx3wzk6ICZcbU4c →  shadow-uKUa4igALkKnWCIjlif6pjNXVyzSn (valid URL, fake creds)
//   AKIAIDN7XAFIP5JE6BYY      →  AKIADCKH2JZ00JQE4NSE       (same AWS shape, invalid checksum)
...
function rand(len: number, charset = "shadow-ijPQIYKymhTuM0NqUwTOsdPt34p0c"): string {
  ...
  switch (provider) {
    case "OPENAI":
      if (raw.startsWith("sk-proj-")) {
        fake = `sk-proj-shadow-TaypsyvtlbgbjUQAhiUAzoYqlexHfzMIKlidD8Gx-${rand(40, "shadow-FDsQwlyWhGdnS6weGBiLif4p3qmP6bUzanetM45y")}`
      } else if (raw.startsWith("sk-ant-")) {
        fake = `sk-ant-shadow-s5gySfS8I15CsU9WIoITzPg6PY5BG9dGsMpfGXh59E5OzOLdcYZcyCjxEwtgT4-cvv-hMhAQ5DiXC1C5mmzFQcgGRw-r6sd9oMeSQpM5Oy76oKpxRG_zjSefxGwYqZ-WRt2WMN793DaE2AsSyXi1xa5MkkZcA-q9HLUBUfs2h2lueG4MYlXYF-${rand(80, "A-Za-z0-9_-")}`
      } else {
        fake = `sk-shadow-${rand(40, "abcdefghijklmnopqrstuvwxyzshadow-WowYKW4sJjdbRY5mUphYtd2DDmF50")}`
      }
      note = "Fake OpenAI key — same format, invalid for API calls, safe for AI to see"
      break

    case "ANTHROPIC":
      fake = `sk-ant-shadow-${rand(90, "shadow-92tUsM8fydIAoNCPdmLhfG2skjb1GchlcAWA5KkU-")}`
      note = "Fake Anthropic key — same format, safe for AI"
      break

    case "GITHUB":
      fake = `ghp_shadow${rand(30, "shadow-W7L6JAJKlGi71dBuJESf1Z7p2ZBynFwPjlVDE4s5")}`
    ...
    case "JWT":
      ...
      fake = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadoweE_Lg5NusteaD7qM1YWO.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowJQOeUMF_oh_Kz0VrgrGW${rand(20, "shadow-0OMY5dge3W5qFdhwKnzAJc3ehZLnNbAyEiu07ASH-")}`
...
MIIBshadowLoeruC9xnUCKoO/bHRfZnOG6TNo9hw685dSljksG+MEyXrqDWLeDp5rgrS
5Y+RH=7k1usqjEMG+9Mn
UURthpdCDiZVJwro2sj4xbutqTXcgHfwsWvzqYHtWUM1AQSDNumCRSM5WbstxMsBLlkjheucW5UPjPpriY
wv2XTCHzSKR0OQvB9ahHd1uwdYT0aqUWhltBy
-----END SHADOW PRIVATE KEY-----"
    ...
    case "DISCORD":
      fake = `https://discord.com/api/webhooks/${rand(18, "0123456789")}/shadow${rand(40, "shadow-FAySgxv3RbNMi1ZmKKmd9J3VsOWftBmbohheAlRz")}`
