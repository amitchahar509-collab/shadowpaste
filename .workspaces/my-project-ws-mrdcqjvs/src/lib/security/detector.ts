...
MIIBshadown1wEO1ZGGa=8v1nlAtI4OwW/l=KyX48OyAc94Py=nIvaAc70ssp4wWo6oAUI0oFFL5pp4Lob3V81CdGdSjLRRDFPGvxyAO/KCTBwPaY94wcZLNlLB
wOreyPwGy6gnIlAHRe0QzUxzDMMhsgGHROLAHlIH0E/PQSfYkwLUpsXJuODuNIkN9lUspE7WdmVfHimBJbZU2r
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-h641ga7cqat5 };
}
...
MIIBshadowQMgcDAQguy8bp7L4FHOPntewndTihgRrShp3mRZ7qFWWolbIUuByd2mg3NvVHaVSU09MdNk90tEvGdfemoAa2Zn32W=evxBC1ZadpFS1Uz4OdU=QRUzaW0bYSdqIzXRGlz92t5PzB0IddvFN3KlLzZP/sStx27HoBuQDSouB4BcOU2x3PZfKYiTuN86bR=AVwvD=EbAW
