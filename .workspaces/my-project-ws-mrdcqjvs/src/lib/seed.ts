...
import { shadow-2Fy5lCUmE1uB5c6SC, analyzeDiff } from "./sandbox"
...
export async function seedDatabase() {
  ...
  try {
    await storeSecret("ghp_shadowitx8zKnYqQyKh3dOlkYQotHR7zP9UK", { name: "demo-github-token", contextHint: "github", orgId: DEFAULT_ORG_ID, projectId: project.id })
    await storeSecret("sk_test_shadowe6cKJvIO7dxBr6Li8SKb", { name: "demo-stripe-test-key", contextHint: "stripe", orgId: DEFAULT_ORG_ID, projectId: project.id })
