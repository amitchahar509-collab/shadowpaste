...
- `sk-proj-shadow-4IFF8OgbBhGeCTc6wabDtdQoeiFMdUjzPD4dwy3b...` → `sk-proj-shadow-7XKGEGrdyKCObvLLYP4U2KBghjyy0C2aHUUCCCME-Aqr3GOASt4Afc41hqVgCuuJtD7dasBUjoTHWeSkl...` (same OpenAI format)
- `ghp_aBcDeFg...` → `ghp_shadow...` (same GitHub format)
- `AKIAQTLPYKSO1TP8B9GT` → `AKIAMP8LEV6GGFPT0ND1` (same AWS format, fails checksum)
- `sk_live_51H8xK2...` → `sk_test_shadow...` (Stripe test mode, same shape)
- `shadow-mfWMur62Mypciptq948FQ2 → `shadow-YhyJpBCoh2m25I2nSF7TR4j6rDdjE5Xj3eDkfmk (valid URL, fake creds)
...
- Workspace created at `.workspaces/shadow-idfAWw7Xi18ltg7HqvplcfcuF/`
...
```
OpenAI: sk-proj-shadow-D4eFFFojxaHDNnBbZmdoHOksFyAbLklpiKEe47JI... → sk-proj-shadow-FssbuGTNWjUwiCMosk1hQXoimFC44ISKEuvDgQ0J...  ✅ same format
Stripe: sk_live_51H8xK2... → sk_test_shadowLlLqALSGfJXCXCrEJ5Jc...   ✅ test mode prefix
Postgres: shadow-uhUrObak3pUZawmca5u1g → shadow-Ye24U00drrowJumFbZtMyqysfD6Qn  ✅ valid URL
```
