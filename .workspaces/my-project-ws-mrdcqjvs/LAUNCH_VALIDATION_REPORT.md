...
```json
{
  "mcpServers": {
    "shadowpaste": {
      ...
      "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowUQSAEPUR0mOZ13GIX5bQ" }
    }
  }
}
```
...
{
  "mcpServers": {
    "shadowpaste": { "url": "http://localhost:3000/api/mcp", "headers": { "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowsFcyHv1VV5zFwnAs08lR" } }
  }
}
```
...
**Proof**:
```
[1] Signup: POST /api/auth/signup {email:"dev@test.com", shadow-rkngg8qgg0hh, name:"Dev", orgName:"DevOrg"}
