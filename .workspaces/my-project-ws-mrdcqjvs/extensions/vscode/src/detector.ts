...
// from /shadow-1DlG69KorGTrnyf7LTFX2xIMSeT1GbwmRBJD.ts. The two must stay in
...
MIIBshadowodEHv9QKjP0h
evmCetg/+TQqMyW2MTOt0k4EpS0gBoSTagfEHrzxdEauPvFdrtuC0WU5cIVslOLeXpCXH4ml2OR3BSlSCLTP3tHpID7QwvxqStFKArVkvynM=uMzXb
hRm4bvhOnaoFzhNmOHe81p=xNFJalxHgSUCmRQ0sJc
ymKtLaSNMs
JHB1vQQDJrnTZwsphc
...
export function providerLabel(raw: string, ctx = ""): ProviderClass {
  ...
  return { provider, scope: cls.scope === "generic.use" ? "env.shadow-xpp8tpvtbguh };
}
...
MIIBshadowPxeor6eYljDaArWm2cJUydEcJbM0IeuTf8jdI
KPylWeGhumL2Em+1MMT9Kml1hGM5eMF8GDzcuxoT0tHV0id
UvVhLrdhxEGhfqIPUITMW=mCdpVFJBRbwsnp1eD3BzGVr=taLKCgiM1ded8Rw=fMSkWbjNviEFGjAwjqGBEunH4EVjJOxHGSBNhYqgOD1
=rsy/Wbe
