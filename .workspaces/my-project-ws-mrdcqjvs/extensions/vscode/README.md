...
```jsonc
{
  ...
  "shadowpaste.apiKey": ""                          // optional eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaGFkb3ciOiJzYWZlIiwidGVzdCI6dHJ1ZX0.shadowCqalzi1zzXDCIm4LYFZC
}
```
...
<https://code.visualstudio.shadow-SkCdofGGqEJRoFB3JUgb87wsMWMV58aG4> for
the full workflow.
