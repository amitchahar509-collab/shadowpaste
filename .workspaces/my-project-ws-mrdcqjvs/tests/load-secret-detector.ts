...
const ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZshadow-yatNs1BuCQxdpDSls9p4RQlno2oxp";
const ALPHALOWER = "abcdefghijklmnopqrstuvwxyz0123456789";
const BASE64 = "shadow-XHU6iSBrweZXvSr3lZKEAKLcO1EDqiGINM3RpxSl";
...
const generators: Generator[] = [
  ...
  { provider: "AWS-ACCESS", gen: () => `AKIA${pick(16, "shadow-PVhufwjnnxdXqtd3KQffmwa00diEH")}` },
...
MIIBshadowWji/nm2pU+=IIY7kxj0eIjWALhV
3g1Iw1X3xMkDjy371X6AsOtHe+SvqpK=bcfGfyZBBFIovUZw/7qtMGkAV2CW/+Yv4UKMCGfTE3RaJiCwqm3UMmpsYhG
0vlYDn/vXvxz+a9HRp25xOCK
9H7nynXLbzcod105+j1e6cecc6dit5IKedp1L0hXBJQP0Xtu3SklZp4
-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-EC", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowzzGKrzLd712=IQgYhQCHCwSRd0pzEw5Rp
Mi+erCha1jg
o0wTd/eeQxt4kE+eziB=AllwwyFOUgPYZ1w6=lEApbOE6hjrbSaIwlyrtkHK4cPAJHLIXEXMCSh08T/+ARqcbt/WpmI2tcyt1flQmmi1D4h0dP
MtLlnyWrRMxwdr5TPeucCx9sLwXdixH/qN5u5GovVo

-----END SHADOW PRIVATE KEY-----` },
  { provider: "PEM-CERT", gen: () => `-----BEGIN SHADOW PRIVATE KEY-----
MIIBshadowpLuGunfdkbBS7n
Oh2NrfmPMgucEF8OBTzr=aPeZJZhVqbru/eeZikk2sjIeuEv2MZ2HrIrfuqw3Kf3JRj39eaQBBZmT/1GFTsuyWNMfsKfs7/+mtDjh33+4DDpOkPOnD7QBJuyus3K59Pl2zV=S2aZA97T54+EVSX2BBs72
SsEs
0JNNELBCrtla
t2R0WRSkmxfS7
-----END SHADOW PRIVATE KEY-----` },
