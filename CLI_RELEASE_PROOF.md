...
- `sk-proj-abc123...` → `sk-proj-shadow-xxx...` (OpenAI)
- `ghp_aBcDeFg...` → `ghp_shadow...` (GitHub)
- `AKIAIOSFODNN7EXAMPLE` → `AKIASHADOWFAKEKEY00` (AWS)
- `sk_live_51H8xK2...` → `sk_test_shadow...` (Stripe)
- `postgresql://admin:pass@host` → `postgresql://shadow:shadow@shadow-db` (Postgres)
