...
- `postgresql://admin:pass@host` → `postgresql://shadow:shadow@shadow-db.internal` (valid URL, fake creds)
...
```
OpenAI: sk-proj-abc123... → sk-proj-shadow-nPpasx5Jn...  ✅ same format
Stripe: sk_live_51H8xK2... → sk_test_shadowQZ9XNlef...   ✅ test mode prefix
Postgres: postgresql://admin:pass@host → postgresql://shadow:shadow@shadow-db  ✅ valid URL
```
