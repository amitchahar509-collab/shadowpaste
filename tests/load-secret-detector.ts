...
const generators: Generator[] = [
  ...
  { provider: "AWS-ACCESS", gen: () => `AKIA${pick(16, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789")}` },
  ...
  { provider: "PEM-RSA", gen: () => `-----BEGIN RSA PRIVATE KEY-----\nMIIEp${pick(400, BASE64)}\n-----END RSA PRIVATE KEY-----` },
  { provider: "PEM-EC", gen: () => `-----BEGIN EC PRIVATE KEY-----\nMHQ${pick(200, BASE64)}\n-----END EC PRIVATE KEY-----` },
  { provider: "PEM-CERT", gen: () => `-----BEGIN CERTIFICATE-----\nMIID${pick(300, BASE64)}\n-----END CERTIFICATE-----` },
